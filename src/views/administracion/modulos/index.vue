    ...
    , methods: {
        ...
        async firstDataLoad() {
            ...
            if ( response.data === 200 || response.status === 200 ) {
                ...
                let tbody = document.getElementById("modulosContent" ) ;
                ...
                $ ( '#corporativoList' ).DataTable( {
                    ...
                    , "columns": [
                        ...
                        , {
                            ...
                            , render: function( data ) {
                                return `
                                    <a href='/Modulos/Detalle/${data}' @click="x(${data})" class="details" >
        ...
        , async saveNewData() {
            ...
            if (
                ! this.newData.moduleName
                || this.newData.moduleName.trim() === ''
            ) {
