                                    ...
                                    <form>
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">Corporative Email:</th>
                                                    <td>
                                                        <input
                                                            type="text"
                                                            class="form-control"
                                                            placeholder="Corporative Email"
                                                            v-model="newData.emails"
                                                        />
                                                    </td>
                                                </tr>
    ...
    , methods: {
        ...
        async firstDataLoad() {
            ...
            if ( response.data === 200 || response.status === 200 ) {
                ...
                let tbody = document.getElementById("usersContent" ) ;
                ...
                $ ( '#empresasList' ).DataTable( {
                    ...
                    , "columns": [
                        ...
                        , {
                            ...
                            , render: function( data ) {
                                return `
                                    <a href='/Usuarios/Detalle/${data}' @click="x(${data})" class="details" >
